...
- [x] **GRID-03**: Retained pages are capped (`maxPages`) with a documented threshold — no unbounded memory growth
- [x] **GRID-04**: A product card renders image, name, price, and rating/reviewCount
