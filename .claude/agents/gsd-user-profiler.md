...
<reference>
@/home/jeff/Documents/start-nest-shop/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/jeff/Documents/start-nest-shop/.claude/get-shit-done/references/user-profiling.md` to load:
