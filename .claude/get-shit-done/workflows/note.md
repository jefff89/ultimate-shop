...
- **Global scope**: `/home/jeff/Documents/start-nest-shop/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/jeff/Documents/start-nest-shop/.claude/notes/`)
...
2. Glob `/home/jeff/Documents/start-nest-shop/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/jeff/Documents/start-nest-shop/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/jeff/Documents/start-nest-shop/.claude/notes/` — works in any directory
