...
```
Agent(
  prompt="Read /home/jeff/Documents/start-nest-shop/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/jeff/Documents/start-nest-shop/.claude/get-shit-done/templates/SECURITY.md`
