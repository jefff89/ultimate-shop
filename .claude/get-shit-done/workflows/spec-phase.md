...
```bash
INIT=$(node "/home/jeff/Documents/start-nest-shop/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/jeff/Documents/start-nest-shop/.claude/get-shit-done/templates/spec.md.
