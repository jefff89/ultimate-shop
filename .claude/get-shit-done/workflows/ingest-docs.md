...
```bash
INIT=$(node "/home/jeff/Documents/start-nest-shop/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/jeff/Documents/start-nest-shop/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
