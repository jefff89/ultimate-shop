...
INSTALL_JS_GLOBAL="/home/jeff/Documents/start-nest-shop/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/jeff/Documents/start-nest-shop/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
