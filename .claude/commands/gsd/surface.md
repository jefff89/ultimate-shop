...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/jeff/Documents/start-nest-shop/.claude/.gsd-surface.json`
(sibling to `/home/jeff/Documents/start-nest-shop/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/jeff/Documents/start-nest-shop/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/jeff/Documents/start-nest-shop/.claude/skills`).
...
`/home/jeff/Documents/start-nest-shop/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/jeff/Documents/start-nest-shop/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/jeff/Documents/start-nest-shop/.claude/.gsd-surface.json`
Install profile marker: `/home/jeff/Documents/start-nest-shop/.claude/.gsd-profile`
Skill dirs: `/home/jeff/Documents/start-nest-shop/.claude/skills/gsd-*/`
Engine module: `/home/jeff/Documents/start-nest-shop/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/jeff/Documents/start-nest-shop/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
